...
csv_path = r"F:\projects\one\huatu\retrieval_num\aaai\26hate\data\cluster_predictions_nodiv1.csv" 
# csv_path = r"F:\projects\one\huatu\retrieval_num\aaai\26hate\data\cluster_predictions_ours3.csv" 
df = pd.read_csv(csv_path)

# === 可选: 创建输出目录 ===
output_dir = r"F:\projects\one\huatu\retrieval_num\aaai\26hate\cluster_plots\nodiv1_true"
...
for cluster_id in sorted(df['cluster'].unique()):
    ...
    save_path = os.path.join(output_dir, f"cluster_{cluster_id}_ratio_macro_f1_plot_en2mm.pdf")
